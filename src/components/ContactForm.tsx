...
export default function ContactForm() {
  ...
  if (isSuccess) {
    return (
      <div className="glass-panel p-8 md:p-10 rounded-2xl border border-emerald-500/20 text-center space-y-6 animate-fade-in">
        ...
        <div className="space-y-2">
          ...
          <p className="text-slate-300 max-w-md mx-auto text-sm leading-relaxed">
            ...
            Our engineering team will review your requirements for <span className="font-medium text-white">{formData.service}</span> 
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 glass-panel p-8 rounded-2xl border border-white/5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg bg-[#070a13] border ${
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-lg bg-[#070a13] border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/30 transition-all duration-300 text-sm"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            } text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/30 transition-all duration-300 text-sm appearance-none cursor-pointer`}
          >
            <option value="" disabled>Select a service...</option>
            <option value="AI & Agentic AI Solutions">AI & Agentic AI Solutions</option>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          onChange={handleChange}
          placeholder="Tell us about your project, goals, key requirements, and timelines..."
          className={`w-full px-4 py-3 rounded-lg bg-[#070a13] border ${
            errors.description ? "border-red-500" : "border-white/10"
          } text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/30 transition-all duration-300 text-sm resize-none`}
        />
        {errors.description && (
          <p className="text-xs text-red-500 flex items-center gap-1">
            <AlertCircle className="w-3.5 h-3.5" />
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 px-5 py-4 rounded-lg text-sm font-semibold text-[#070a13] bg-[#10b981] hover:bg-[#059669] hover:shadow-[0_0_25px_rgba(16,185,129,0.3)] disabled:opacity-50 disabled:hover:shadow-none transition-all duration-300 cursor-pointer"
      >
        {isSubmitting ? (
          <>
